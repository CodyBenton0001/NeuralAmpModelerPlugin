...
// AMPRYX skin: 384px main UI (compact single-row header) + 84px favorites bar
// + 28px utility bar = 496. Keep in sync with the k*Height constants in
// NAMToneGalleryControl.h.
#define PLUG_HEIGHT 496
#define PLUG_FPS 60
